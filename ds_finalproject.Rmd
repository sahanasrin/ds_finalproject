...
#In this secondary phase of data analysis, we can see that many of the variables that are of interest to us exhibit a left skew. Thus, we must find a way to mitigate the effects of this. 
```{r EDA}
