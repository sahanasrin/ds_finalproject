...
#child_opp_data1 <- read_csv("~/Desktop/GU_3Spring2022/DataSci/FinalProject/ds_finalproject/data/index.csv")
child_opp_data1 <- read_csv("data/index.csv")
#child_opp_data1 <- read_csv("https://github.com/sahanasrin/ds_finalproject/blob/main/data/index.csv")
...
## Census API Query Method 2 (via a url query) to pull median income and some mapping exploration
```{r}
#using census API Query to get data on median household income levels in 50 states
...
# travel_time_viz <- boxplot(travel_min_work_agg~income_bracket, 
#         data = states_2017_EDA,
#         main = "Travel Time to Work By Income Bracket", 
#         xlab = "Income Bracket", 
#         ylab = "Time Traveled to Work Aggregated", 
#         col = "orange", 
#         border = "brown"
# ) 
# travel_time_viz
...
#   summarize(computers = sum(computer_count)) %>% 
#   ggplot(aes(x=income_bracket, y=computer_count, fill=group)) +
...
#Unsupervised Machine Learning Model Using States
