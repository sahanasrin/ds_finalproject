...
#![EDA for all variables]("/ds_finalproject/images/greatestFigure.png")

# eda_figure <- "/ds_finalproject/images/greatestFigure.png"
# eda <- readPNG(eda_figure, native = TRUE, info = TRUE)
# eda
```
